...
public class MediaPlayerService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    private void buildNotification(PlaybackStatus playbackStatus) {
        ...
        NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID ,"NOTIFICATION CHANNEL NAME",importance);
        ...
        noti.notify(NOTIFICATION_ID, notificationBuilder.build());
    }
